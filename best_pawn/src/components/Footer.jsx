    ...
    <>
      <footer class="bg-white  ">
        <div class="mx-auto w-full max-w-screen-xl">
          <div class="grid grid-cols-2 gap-8 py-6  md:grid-cols-4">
            <div>
            ...
            <div className="container">
              <h1 className="text-7xl text-center mb-6">Ladaza</h1>
              <img
          ...
          <div class="px-4 py-6  dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500  sm:text-center">
              © 2023 <a href="https://flowbite.com/">Michael Roring's</a>. All
              Rights Reserved.
            </span>
