    ...
    <>
      <div className="fixed sticky top-0 z-50 bg-white border border-2 pb-4">
        ...
        <div className="px-16 mt-1 flex mx-16">
          ...
          >
            <div class="px-3 py-2 bg-purple-100 border-b border-gray-200 rounded-t-lg dark:border-gray-600 dark:bg-gray-700">
              <h3 class="font-semibold text-gray-900 ">Your cart is empty</h3>
            </div>
            <div class="px-3 py-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                width="847.6929"
                height="656"
                viewBox="0 0 847.6929 656"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                className="w-36 h-36 pl-20"
              >
                <path
                  ...
                  transform="translate(-176.15355 -122)"
                  fill="#f2f2f2"
                />
                <path
                ...
                />
                <path
                  id="b06866c4-d0b9-420f-a9d2-389dd10be0a8-279"
                  data-name="Path 22"
                ...
                />
                <path
                  id="fb337c3c-e64d-4daa-8f83-1de4a3033e68-280"
                  data-name="Path 23"
                  ...
                  fill="#fff"
                />
                <circle cx="304.6929" cy="411" r="11" fill="#ad63ff" />
                <path
                ...
                />
                <path
                  d="M582.22834,778h-381a1,1,0,0,1,0-2h381a1,1,0,1,1,0,2Z"
                  transform="translate(-176.15355 -122)"
                  fill="#3f3d56"
                />
              </svg>
              <p>Add some products to your stuff</p>
            </div>
